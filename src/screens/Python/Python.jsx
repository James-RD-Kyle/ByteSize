...
const Python = ({ navigation }) => {
	...
	const lessons = [
		...
		{ id: 2, title: "Your First Program", description: "Printing text using print()" },
		...
		{ id: 5, title: "Common Data Types", description: "int, str, bool" },
		{ id: 6, title: "Updating Variables", description: "Change variable values" },
		{ id: 7, title: "User Input", description: "Read text using input()" },
	...
	const handleLessonPress = (lessonId) => {
		navigation.navigate(`PythonLesson${lessonId}`);
	};
				...
				<View className="min-h-screen">
					...
					<View className="flex-1 px-6 py-5">
						...
						<Text className="text-sm text-gray-500 mb-6" style={{ lineHeight: 20 }}>
							Master Python fundamentals with hands-on practice
						</Text>
