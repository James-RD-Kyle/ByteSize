...
const JSLesson4 = ({ navigation }) => {
	const insets = useSafeAreaInsets();
	
	const handleLessonComplete = (isCorrect) => {
		if (isCorrect) {
			console.log('JavaScript Lesson 4 completed!');
				...
				<View className="flex-1 px-6 py-5">
					...
					<Text className="text-3xl font-bold mb-2 text-slate-900">
						...
						<Text className="text-sm text-gray-500 mb-6" style={{ lineHeight: 20 }}>
							Variables — Store values using let/const
						</Text>
						...
						<LessonCard 
							title="Variables"
							lessonContent={
								"Concept: Variables store values so you can use them later.\n\n" +
								"Example:\nlet age = 20;\n\n" +
								"Key Point: let creates a variable you can change.\n\n" +
								"Mini task: Create a variable score with value 100."
							}
