...
const JSLesson3 = ({ navigation }) => {
	const insets = useSafeAreaInsets();
	
	const handleLessonComplete = (isCorrect) => {
		if (isCorrect) {
			console.log('JavaScript Lesson 3 completed!');
				...
				<View className="flex-1 px-6 py-5">
					...
					<Text className="text-3xl font-bold mb-2 text-slate-900">
						...
						<LessonCard 
							title="Comments"
							lessonContent={
								"Concept: Comments are ignored by JavaScript.\n\n" +
								"Example:\n// This is a comment\n\n" +
								"Key Point: Comments explain code.\n\n" +
								"Mini task: Write a comment that says: This is JavaScript"
							}
							correctAnswer={"// This is JavaScript"}
