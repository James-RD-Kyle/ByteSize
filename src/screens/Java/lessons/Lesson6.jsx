...
const JavaLesson6 = ({ navigation }) => {
	const insets = useSafeAreaInsets();
	const { markLessonComplete } = useProgress();
	
	const handleLessonComplete = (isCorrect) => {
		if (isCorrect) {
			markLessonComplete('java', 6);
			console.log('Java Lesson 6 completed!');
		}
	};
					...
					<Text className="text-3xl font-bold mb-2 text-slate-900">
						...
						<LessonCard 
							...
							lessonContent={
								...
								"Example:\nscore = score + 1;\n\n" +
								"Key Point: The right side is calculated first.\n\n" +
