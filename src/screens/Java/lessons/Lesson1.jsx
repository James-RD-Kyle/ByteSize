...
const JavaLesson1 = ({ navigation }) => {
	const insets = useSafeAreaInsets();
	const { markLessonComplete } = useProgress();
	
	const handleLessonComplete = (isCorrect) => {
		if (isCorrect) {
			markLessonComplete('java', 1);
			console.log('Java Lesson 1 completed!');
		}
	};
				...
				<View className="flex-1 px-6 py-5">
					...
					<Text className="text-3xl font-bold mb-2 text-slate-900">
						...
						<Text className="text-sm text-gray-500 mb-6" style={{ lineHeight: 20 }}>
							What Is Java? — A quick intro to Java
						</Text>
						...
						<LessonCard 
							title="What Is Java?"
							lessonContent={
								"Concept: Java is a programming language used for apps, Android, and backend systems.\n\n" +
								"Example:\n// This is what Java code looks like\n\n" +
								"Key Point: Java is widely used and runs on many platforms.\n\n" +
								'Mini task: Print "Welcome to ByteSize!"'
							}
							correctAnswer={'System.out.println("Welcome to ByteSize!");'}
