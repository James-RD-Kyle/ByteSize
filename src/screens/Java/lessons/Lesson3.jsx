...
const JavaLesson3 = ({ navigation }) => {
	const insets = useSafeAreaInsets();
	const { markLessonComplete } = useProgress();
	
	const handleLessonComplete = (isCorrect) => {
		if (isCorrect) {
			markLessonComplete('java', 3);
			console.log('Java Lesson 3 completed!');
		}
	};
				...
				<View className="flex-1 px-6 py-5">
					...
					<Text className="text-3xl font-bold mb-2 text-slate-900">
						...
						<LessonCard 
							title="Comments"
							lessonContent={
								"Concept: Comments are ignored by Java.\n\n" +
								"Example:\n// This is a comment\n\n" +
								"Key Point: Comments help explain code.\n\n" +
								"Mini task: Write a comment that says: This is Java"
							}
							correctAnswer={"// This is Java"}
